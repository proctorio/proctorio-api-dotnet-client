...
/// <summary>
/// URLs to redirect Candidates to after graceful or ungraceful exam submission.
/// </summary>
public class RedirectSettings
{
    /// <summary>
    /// After graceful/successful submission of the exam the Candidate will be redirected to graceful_submission_url.
    /// </summary>
    ...
    /// <summary>
    /// After ungraceful exam end, the Candidate will be redirected to ungraceful_submission_url when they click the "Okay" button within the "Attempt End" message.
    /// </summary>
